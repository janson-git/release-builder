    ...
    <div class="pure-g">
        <div class="pure-u-1">
            <div>
                ...
                <a href="/projects/{{ $project->getId() }}/fetch?return=1" class="pure-button btn-actionable">
                    {{ __('refetch_repositories') }}
                </a>
            </div>
            <form class="pure-form" action="/branches/save/{{ $project->getId() }}" method="post"
            ...
            @endif
                ...
                <h1><input type="text" placeholder="{{ __('filter_branches') }}" onkeydown="aFilter.filter()"
                           class="mainInput"
